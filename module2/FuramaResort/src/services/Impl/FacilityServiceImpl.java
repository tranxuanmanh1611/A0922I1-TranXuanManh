...
public class FacilityServiceImpl implements services.FacilityService {
...
for(String service: facilityList.keySet()){
    System.out.println(service+": Số lần sử dụng: "+facilityList.get(service));
}
    }
}
